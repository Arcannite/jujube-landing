export default function Footer() {
  return (
    <div className="
      fixed inset-x-0 bottom-0 w-screen bg-white py-1 z-10
      text-center text-gray-800 font-bold text-sm sm:text-base lg:text-lg
      grid grid-cols-4 lg:grid-cols-6"
    >
      <div>
        <a href="/about" className="hover:text-[#998a43]"> About </a>
      </div>
      <div>
        <a href="/products" className="hover:text-[#998a43]"> Products </a>
      </div>
      <div>
        <a href="#"> Reviews </a>
      </div>
